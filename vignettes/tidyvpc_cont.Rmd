...
```{r message=FALSE, fig.width = 9, fig.height = 6, fig.align='center', out.width="0.9\\linewidth"}
vpc <- observed(obs_data, x=TIME, y=DV) %>%
    simulated(sim_data, y=DV) %>%
    binning(bin = NTIME)
```
...
```{r warning = FALSE, fig.width = 9, fig.height = 6, fig.align='center', out.width="0.9\\linewidth"}
...
```{r  fig.width = 9, fig.height = 6, fig.align='center', out.width="0.9\\linewidth", warning = FALSE}
vpc <- observed(obs_data, x=TIME, y=DV) %>%
    simulated(sim_data, y=DV) %>%
...
```{r  fig.width = 9, fig.height = 6, fig.align='center', out.width="0.9\\linewidth", warning = FALSE, eval = FALSE}
